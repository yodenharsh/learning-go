...
func (x *HelloResponse) SetMessage(v string) {
	x.xxx_hidden_Message = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *HelloResponse) HasMessage() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *HelloResponse) ClearMessage() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
...
var file_greeter_proto_goTypes = []any{
	(*HelloRequest)(nil),  // 0: mainpb.HelloRequest
	(*HelloResponse)(nil), // 1: mainpb.HelloResponse
}
