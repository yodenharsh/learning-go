...
func (c *calculatorServiceClient) Chat(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ChatMessage, ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CalculatorService_ChatClient = grpc.BidiStreamingClient[ChatMessage, ChatMessage]
...
func (UnimplementedCalculatorServiceServer) Chat(grpc.BidiStreamingServer[ChatMessage, ChatMessage]) error {
...
func _CalculatorService_Chat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculatorServiceServer).Chat(&grpc.GenericServerStream[ChatMessage, ChatMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CalculatorService_ChatServer = grpc.BidiStreamingServer[ChatMessage, ChatMessage]
